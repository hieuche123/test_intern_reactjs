  ...
  const updateImagePosition = useCallback(() => {
    ...
    if (map) {
      ...
      if (bounds) {
        ...
        const mapAspectRatio = mapDiv.width / mapDiv.height;
        ...
        img.onload = () => {
          ...
          let imageScaleWidth = imageScale;
          let imageScaleHeight = imageScale;

          if (mapAspectRatio > imgAspectRatio) {
            imageScaleWidth = imageScale * (mapAspectRatio / imgAspectRatio);
          } else {
            imageScaleHeight = imageScale * (imgAspectRatio / mapAspectRatio);
          }
          ...
          setImageScale({ width: imageScaleWidth, height: imageScaleHeight });
        };
      }
    }
  }, [imageScale]);
  ...
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden' }}>
      ...
      <img
        ...
        style={{
          width: `${100 * imageScale.width}%`,
          height: `${100 * imageScale.height}%`,
          opacity: opacity,
          transform: `translate(-50%, -50%) scale(${imageScale.width}, ${imageScale.height})`,
