  ...
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden' }}>
      <GoogleMap
        ...
        center={initialCenter} // Sử dụng initialCenter thay vì center
        zoom={mapZoom}
        options={mapOptions}
        onLoad={onMapLoad}
        onBoundsChanged={() => {
          ...
          if (map) {
            ...
            const imageCenterX = (newCenter.lng() - initialCenter.lng) / (mapSize.width / 2);
            const imageCenterY = (initialCenter.lat - newCenter.lat()) / (mapSize.height / 2);
