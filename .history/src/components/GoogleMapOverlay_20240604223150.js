...
To synchronize the image zoom with the Google Map zoom level, you'll need to capture the zoom events from the map and update the image size accordingly. Here's the modified code:
