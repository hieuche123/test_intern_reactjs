...
function App() {
  ...
  return (
    <div>
      <div {...getRootProps()} style={{ position: 'absolute', top: 2, left: 10, zIndex: 1, padding: 10, background: 'white', borderRadius: 4 }}>
        <input {...getInputProps()} />
        <p>Kéo & thả ảnh hoặc click để chọn ảnh</p>
      </div>
      <div style={{ position: 'absolute', top: 60, left: 10, zIndex: 1,background: 'white', padding: 10, borderRadius: 4 }}>
        <div>
