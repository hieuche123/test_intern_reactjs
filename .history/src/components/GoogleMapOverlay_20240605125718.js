...
const overlayImageStyle = (scale, opacity, imageCenter,mapZoom) => ({
  width: `${100 * scale}%`,
  height: `${100 * scale}%`,
  opacity: opacity,
  position: 'absolute',
  top: `calc(50% - ${imageCenter.y/mapZoom*scale}px)`,
  left: `calc(50% - ${imageCenter.x/13.4*scale}px)`,
  ...
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden' }}>
      ...
      <img
        src={anh}
        alt="Overlay"
        style={overlayImageStyle(imageZoom, opacity, imageCenter,mapZoom)}
      />
