...
const GoogleMapOverlay = () => {
  ...
  const handleMouseMove = (e) => {
    ...
    if (map) {
      ...
      const newCenterLat = center.lat - (mouseY - mapSize.height / 2) / mapSize.height * (center.lat - imageCenter.y);
      const newCenterLng = center.lng + (mouseX - mapSize.width / 2) / mapSize.width * (imageCenter.x - center.lng);
