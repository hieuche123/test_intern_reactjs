      ...
      <GoogleMap
        ...
        onBoundsChanged={() => {
          ...
          if (map) {
            ...
            setImageCenter({
              x: (center.lng - newBounds.getSouthWest().lng) / (newBounds.getNorthEast().lng - newBounds.getSouthWest().lng) * mapSize.width,
              y: (newBounds.getNorthEast().lat - center.lat) / (newBounds.getNorthEast().lat - newBounds.getSouthWest().lat) * mapSize.height,
            });
          }
        }}
      />
