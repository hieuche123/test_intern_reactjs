        ...
        >
          {image && (
            <GroundOverlay
              url={image}
              bounds={{
                north: mapCenter.lat + (imageSize.height / 2) * 0.000009,
                south: mapCenter.lat - (imageSize.height / 2) * 0.000009,
                east: mapCenter.lng + (imageSize.width / 2) * 0.000009,
                west: mapCenter.lng - (imageSize.width / 2) * 0.000009,
              }}
              opacity={opacity}
            />
          )}
