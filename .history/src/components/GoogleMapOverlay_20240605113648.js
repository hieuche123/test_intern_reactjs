...
const GoogleMapOverlay = () => {
  ...
  const handleMapMouseMove = useCallback((e) => {
    ...
    const mapSize = mapContainerRef.current.getBoundingClientRect();
    const offsetX = clientX - mapSize.left;
    const offsetY = clientY - mapSize.top;
    const imageCenterX = offsetX - mapSize.width / 2;
    const imageCenterY = offsetY - mapSize.height / 2;
