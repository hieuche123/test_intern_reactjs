...
const MapComponent = () => {
  ...
  return (
    <div style={{ width: '100%', height: '100vh', position: 'relative' }}>
      <input type="file" onChange={handleFileUpload} accept="image/*" style={{ position: 'absolute', top: '10px', left: '10px', zIndex: '1000' }} />
      <input
        type="range"
        min="0"
        max="1"
        ...
        style={{ position: 'absolute', top: '10px', left: '60px', zIndex: '1000' }}
      />
      {isLoaded && (
        <GoogleMap
