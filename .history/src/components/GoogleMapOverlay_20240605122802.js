...
const GoogleMapOverlay = () => {
  ...
  const updateImagePosition = () => {
    ...
    if (map) {
      ...
      const worldCoordinateCenter = projection.fromLatLngToPoint(newCenter);
      const imageCenterX = worldCoordinateCenter.x * Math.pow(2, mapZoom) * imageZoom;
      const imageCenterY = worldCoordinateCenter.y * Math.pow(2, mapZoom) * imageZoom;
